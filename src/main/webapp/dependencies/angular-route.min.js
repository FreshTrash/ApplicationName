            ...
            link: function(a, c, b, f, w) {
                ...
                function v() {
                    ...
                    if (e.isDefined(b && b.$template)) {
                        var b = a.$new(),
                            d = s.current;
                        l = w(b, function(d) { k.enter(d, null, l || c, function() {!e.isDefined(t) || t && !a.$eval(t) || g() });
                            y() });
                        h = d.scope = b;
    ...
    n = e.module("ngRoute", ["ng"]).provider("$route", function() {
        ...
        function g(a, e) {
            ...
            a = a.replace(/([().])/g, "\\$1").replace(/(\/)?:(\w+)([\?\*])?/g, function(a, e, b, c) { a = "?" === c ? c : null;
                ...
                e = e || "";
                return "" + (a ? "" : e) + "(?:" + (a ? e : "") + (c && "(.+?)" || "([^/]+)") + (a || "") + ")" + (a || "") }).replace(/([\/$\*])/g, "\\$1");
        ...
        this.otherwise = function(a) { this.when(null, a);
            return this };
        this.$get = ["$rootScope", "$location", "$routeParams", "$q", "$injector", "$http", "$templateCache", "$sce", function(a, c, b, f, g, n, v, h) {
            ...
            function t(a, c) {
                ...
                return b.join("") }
            var u = !1,
                r = { routes: k, reload: function() { u = !0;
                        a.$evalAsync(l) } };
